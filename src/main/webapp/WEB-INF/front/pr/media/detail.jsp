...
$(document).ready(function() {
	if(nullChk("${idx}"))
	{
		...
		$('#prev_move').attr("onclick","javascript:location.href=\'/media_board?idx=${before_idx}'");
		$('#next_move').attr("onclick","javascript:location.href=\'/media_board?idx=${after_idx}'");
	 ...
	 <div class="sub_banner">
	 	...
	 	<div class="sub_nav_wrap"> 	
	 		<ul class="sub_nav">
	 			...
	 			<li class="lato"><a href="/media">NEWS</a></li>
	 			<li class="on lato"><a href="/pr">MEDIA</a>
	 	...
	 	<div class="sub_container">
	 		<div class="board-view-content">
 				...
 				<div class="board-button-wrap">
	 				<a href="/media" class="browse-more pc-ver">   
                             <strong class="">                                
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240.1 240.3" class="svgImg">
                                 ...
                                 <span class="link-wrap">
                                    ...
                                    <span class="lato navy">MEDIA LIST</span>
                                </span>
                                </strong>
                            </a>  
