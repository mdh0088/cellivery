...
$(document).ready(function() {
	if(nullChk("${idx}"))
	{
		...
		$('#prev_move').attr("onclick","javascript:location.href=\'/news_board?idx=${before_idx}'");
		$('#next_move').attr("onclick","javascript:location.href=\'/news_board?idx=${after_idx}'");
                             ...
                             <strong class="">                                
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240.1 240.3" class="svgImg">
                                 ...
                                 <span class="link-wrap">
                                    ...
                                    <span class="lato navy">NEWS LIST</span>
                                </span>
                                </strong>
                            </a>  
