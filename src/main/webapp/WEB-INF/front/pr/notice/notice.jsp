		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				...
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner +='	<div class="subject"><a href="javascript:location.href=\'/notice_board?idx='+result.list[i].idx+'\'">['+result.list[i].cate_title+'] '+result.list[i].title+'</a></div>';
...
<div class="subpage pr">
	 <div class="sub_banner">
	 	...
	 	<div class="sub_nav_wrap"> 	
	 		<p class="mo-ver current_menu">NOTICE<img src="/img/sub/m_sub_nav_btn.png" alt="셀리버리L&H"></p>
	 		<ul class="sub_nav">
	 			<li class="lato on"><a href="/notice">NOTICE</a>
	 ...
	 <div class="sub_content">
	 	<div class="sub_container">
	 		<div class="sub_top_box">
	 			<h3 class="sub_title lato black">Notice</h3>
		 		<div class="sub_search_box">
                    ...
                    <!-- 
                   <form id="new_search" class="search" name="search_form" method="post" enctype="">
                    	<input type="text" id="search_name" placeholder="Search" onfocus="this.placeholder=''" onblur="this.placeholder='Search'">
                    	<button><img src="/img/sub/pr/board-search.png" alt="셀리버리L&H"></button>
                    </form>
                     -->
                     <div class="search">
		 	...
		 	<!-- 
 		 	<div class="pagination">
 		 		...
 		 		<a href="javascript:void(0)" class="prev">
 		 			<img src="/img/sub/pr/board-prev.png" alt="prev" class="pc-ver">
 		 			<img src="/img/sub/pr/board-prev-m.png" alt="prev" class="mo-ver">
 		 		</a>
 		 		<div class="pager lato">
 		 		...
 		 		<a href="javascript:void(0)" class="next">
 		 			<img src="/img/sub/pr/board-next.png" alt="next" class="pc-ver">
 		 			<img src="/img/sub/pr/board-next-m.png" alt="next" class="mo-ver">
