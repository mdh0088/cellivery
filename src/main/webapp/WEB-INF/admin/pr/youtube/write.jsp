...
function fncSubmit(){
	...
	$("#fncForm").ajaxSubmit({ 
		success: function(data)
		{
			...
			var result = JSON.parse(data);
			alert(result.msg);
			location.href="/admin/pr/youtube/list";
		}
	});
...
<div id="container">
	<div class="inner">
		<div class="inner_top">
			<h2 class="ad_tit">Youtube 등록/수정</h2>
			<p class="ad_titDesc">Youtube 게시글을 수정하고 관리합니다.</p>
		</div>	
		<form id="fncForm" name="fncForm" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" id="tbl" name="tbl" value="youtube">
			...
			<div class="inner_cont write_cont">
				...
				<div class="write_content youtube_url">
					<p class="writebox_tit">영상 URL</p>
					<div class="writebox_cont">
						<input type="text" id="url" name="url" placeholder="영상 URL을 입력하세요.">
					</div>
				</div>
				<div class="write_thumb">
					...
					<div class="writebox_cont">
						...
						<p class="thumb_desc">* 권장 사이즈 : 305 x 171 px</p>
					</div>
				</div>
			</div>
			<div class="btn_box">
				<label for="goList_btn" class="btn goList_btn">목록</label>
				<input type="button" id="goList_btn" value="목록" onclick="location.href='/admin/pr/youtube/list'">
