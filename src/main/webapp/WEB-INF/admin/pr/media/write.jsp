...
function fncSubmit(){
	...
	$("#fncForm").ajaxSubmit({ 
		success: function(data)
		{
			...
			var result = JSON.parse(data);
			alert(result.msg);
			location.href="/admin/pr/media/list";
		}
	});
...
<div id="container">
	<div class="inner">
		<div class="inner_top">
			<h2 class="ad_tit">Media 등록/수정</h2>
			<p class="ad_titDesc">Media 게시글을 수정하고 관리합니다. </p>
		</div>
		<form id="fncForm" name="fncForm" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" id="tbl" name="tbl" value="media">
			...
			<div class="btn_box">
				...
				<input type="button" id="goList_btn" value="목록" onclick="location.href='/admin/pr/media/list'">
