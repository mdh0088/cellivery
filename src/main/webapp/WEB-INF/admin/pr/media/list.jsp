		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				...
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner+='		</label>';
					inner+='	</td>';
					inner+='	<td><input type="button" class="btn modi_btn" value="수정" onclick="javascript=location.href=\'/admin/pr/media/write?idx='+result.list[i].idx+'\' "></td>';
					inner+='</tr>';
				}
			}
			else
...
<div id="container">
	<div class="inner">
		<div class="inner_top">
			<h2 class="ad_tit">Media 관리</h2>
			<p class="ad_titDesc">Media 게시글을 수정하고 관리합니다. (상단 고정은 최대 5개까지 가능합니다.)</p>
		</div>
		...
		<div class="inner_cont">
			<div class="list_cont_top">
				...
				<input type="button" class="submit_btn btn" value="등록" onclick="javascript:location.href='/admin/pr/media/write'">
			</div>
